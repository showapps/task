...
layui.define(["jquery", "miniMenu", "element","miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            $.post(options.iniUrl,{},function(res){
                if(res.status == 200){
                    ...
                    miniTab.render({
                        ...
                        listenSwichCallback: function (tabId) {
                            if(options.listenSwichCallback){
                                options.listenSwichCallback(tabId);
                            }
        ...
        renderHome: function (data) {
            ...
            $('#layuiminiHomeTabIframe').html('<iframe id="welcome" width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  src="' + data.href + '"></iframe>');
        },
